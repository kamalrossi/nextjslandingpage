        ...
        <Row className="justify-content-center">
          <Col lg={6} md={8}>
            <div className="title text-center mb-5">
              <h3 className="font-weight-normal text-dark">Story <span className="text-warning">ElegantWallet</span></h3>
          ...
          <Col md={{ size:7, offset :1 }}>
            <Row>
              <Col md={6}>
                ...
                <p className="text-muted font-weight-light">Banking, utilities and ecommerce are our service areas..Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type</p>
              </Col>
              <Col md={6}>
